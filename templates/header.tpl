...
<body>
	...
	<main id="panel">
		<nav class="navbar navbar-default navbar-fixed-top header" role="navigation" id="header-menu" component="navbar" style="<!-- IF categories.bgColor -->border-color: {categories.bgColor};<!-- ENDIF categories.bgColor -->">
