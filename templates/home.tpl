				...
				<div class="category-bar">
					...
					<div class="category-box">
						...
						<div class="category-info">
							...
							<a href="{relative_path}/category/{categories.slug}" itemprop="url">
							<!-- ENDIF categories.link-->
								<h4 style="background: {categories.color}; color: {categories.color}"><!-- IF categories.icon --><i class="fa {categories.icon}"></i> <!-- ENDIF categories.icon -->{categories.name}</h4>	<!-- IF !categories.link -->
